        ...
        <section id="football">
            ...
            <div class="section-container">
                <div class="columns image">
                    <img src="https://www.exasol.com/app/uploads/2020/06/football-analytics-1.jpg">
                </div>
                <div class="columns content">
                    <div class="content-container">
                        <h6>Football is a family of team sports that involve, to varying degrees, kicking a ball to score a goal. Unqualified, the word football normally means the form of football that is the most popular where the word is used. Sports commonly called football include association football (known as soccer in North America and Oceania); gridiron football (specifically American football or Canadian football); Australian rules football; rugby union and rugby league; and Gaelic football.[1] These various forms of football share to varying extent common origins and are known as football codes.</h6>
                        <h4>Timing:</h4>
